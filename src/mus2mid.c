...
static doombool WriteTime(unsigned int time, MEMFILE *midioutput)
{
...
static doombool WriteEndTrack(MEMFILE *midioutput)
{
...
static doombool WritePressKey(byte channel, byte key,
...
static doombool WriteReleaseKey(byte channel, byte key,
                               MEMFILE *midioutput)
{
...
static doombool WritePitchWheel(byte channel, short wheel,
                               MEMFILE *midioutput)
{
...
static doombool WriteChangePatch(byte channel, byte patch,
                                MEMFILE *midioutput)
{
...
static doombool WriteChangeController_Valued(byte channel,
                                            byte control,
                                            byte value,
                                            MEMFILE *midioutput)
{
...
static doombool WriteChangeController_Valueless(byte channel,
                                               byte control,
                                               MEMFILE *midioutput)
{
...
static doombool ReadMusHeader(MEMFILE *file, musheader *header)
{
    doombool result;
...
doombool mus2mid(MEMFILE *musinput, MEMFILE *midioutput)
{
