...
DOOM_C_API typedef enum
{
	...
	S_BETABALL2_SPAWN1,
	S_BETABALL2_SPAWN2,
	S_BETABALL2_EXPLODE1,
	S_BETABALL2_EXPLODE2,
	S_BETABALL2_EXPLODE3,
	S_BETASCEPTRE,
	S_BETABIBLE,
	S_BETASOUL_STAND,
	S_BETASOUL_RUN1,
	...
	S_PRBOOM_EASTEREGG8,
	S_PRBOOM_EASTEREGG9,
	S_PRBOOM_EASTEREGG10,
	S_PRBOOM_EASTEREGG11,
	S_PRBOOM_EASTEREGG12,

	NUMSTATES_PRBOOMPLUS,
...
DOOM_C_API typedef enum mobjtype_e {
	...
	MT_PUSH = MT_NUMVANILLATYPES,
	MT_PULL,
	MT_NUMBOOMTYPES,

	MT_DOGS = MT_NUMBOOMTYPES,
	MT_PLASMA1,
	MT_PLASMA2,
	MT_SCEPTRE,
	MT_BIBLE,
	...
	MT_MUSICSOURCE = MT_NUMMBFTYPES,
	MT_GIBDTH,
	MT_NUMMISCTYPES,

	MT_BLUEBLOOD = MT_NUMMISCTYPES,
	MT_GREENBLOOD,
	MT_FUZZYBLOOD,
	MT_TRAIL,
	MT_NUMRETROTYPES,

	MT_STEALTHBABY = MT_NUMMISCTYPES,
	MT_STEALTHVILE,
	MT_STEALTHBRUISER,
	MT_STEALTHHEAD,
	MT_NUMPRBOOMTYPES,

	NUMMOBJTYPES = MT_NUMPRBOOMTYPES,
...
{
public:
	inline const state_t& operator[]( int32_t statenum )		{ return Fetch( statenum ); }
	inline const state_t& operator[]( statenum_t statenum )		{ return Fetch( (int32_t)statenum ); }
...
{
public:
	inline const mobjinfo_t& operator[]( int32_t mobjnum )		{ return Fetch( mobjnum ); }
	inline const mobjinfo_t& operator[]( mobjtype_t mobjnum )	{ return Fetch( (int32_t)mobjnum ); }
