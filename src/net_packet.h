...
doombool NET_ReadInt8(net_packet_t *packet, unsigned int *data);
doombool NET_ReadInt16(net_packet_t *packet, unsigned int *data);
doombool NET_ReadInt32(net_packet_t *packet, unsigned int *data);

doombool NET_ReadSInt8(net_packet_t *packet, signed int *data);
doombool NET_ReadSInt16(net_packet_t *packet, signed int *data);
doombool NET_ReadSInt32(net_packet_t *packet, signed int *data);
