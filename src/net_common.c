...
static doombool NET_Conn_ReliablePacket(net_connection_t *conn, 
                                       net_packet_t *packet)
{
    unsigned int seq;
    net_packet_t *reply;
...
doombool NET_Conn_Packet(net_connection_t *conn, net_packet_t *packet, 
...
doombool NET_ValidGameSettings(GameMode_t mode, GameMission_t mission,
