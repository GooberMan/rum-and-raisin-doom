...
doombool NET_ReadConnectData(net_packet_t *packet, net_connect_data_t *data);

extern void NET_WriteSettings(net_packet_t *packet, net_gamesettings_t *settings);
extern doombool NET_ReadSettings(net_packet_t *packet, net_gamesettings_t *settings);

extern void NET_WriteQueryData(net_packet_t *packet, net_querydata_t *querydata);
extern doombool NET_ReadQueryData(net_packet_t *packet, net_querydata_t *querydata);

extern void NET_WriteTiccmdDiff(net_packet_t *packet, net_ticdiff_t *diff, doombool lowres_turn);
extern doombool NET_ReadTiccmdDiff(net_packet_t *packet, net_ticdiff_t *diff, doombool lowres_turn);
...
doombool NET_ReadFullTiccmd(net_packet_t *packet, net_full_ticcmd_t *cmd, doombool lowres_turn);
void NET_WriteFullTiccmd(net_packet_t *packet, net_full_ticcmd_t *cmd, doombool lowres_turn);

doombool NET_ReadSHA1Sum(net_packet_t *packet, sha1_digest_t digest);
...
doombool NET_ReadWaitData(net_packet_t *packet, net_waitdata_t *data);

doombool NET_ReadPRNGSeed(net_packet_t *packet, prng_seed_t seed);
