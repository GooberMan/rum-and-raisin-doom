...
static doombool NET_CL_InitClient(void)
{
...
static doombool NET_CL_InitServer(void)
{
...
static doombool NET_CL_RecvPacket(net_addr_t **addr, net_packet_t **packet)
{
    net_packet_t *popped;
...
static doombool NET_SV_RecvPacket(net_addr_t **addr, net_packet_t **packet)
{
    net_packet_t *popped;
