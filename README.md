...
```
sudo apt install clang-10 automake autoconf libtool git pkg-config libsdl2-dev libsdl2-mixer-dev libsdl2-net-dev libpng-dev libminizip-dev libcurl4-openssl-dev libsamplerate0-dev
./autogen.sh
make
```
